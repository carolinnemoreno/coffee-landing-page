...
Uma landing page responsiva para uma cafeteria fictícia.
Criada com HTML, CSS, Bootstrap Icons, Google Fonts e um pouco de JavaScript para filtragem e carrinho simples via LocalStorage.
